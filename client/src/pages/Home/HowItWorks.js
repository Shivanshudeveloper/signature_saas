              ...
              <Col lg="7" md="6" className="mt-4 pt-2">
                <div className="section-title ms-lg-5">
                  <SectionTitleLeft
                    ...
                    desc="You can combine all the  templates into a single one, you can take a component from the Application theme and use it in the Website."
            ...
            <Row className="align-items-center">
              ...
              >
                <div className="section-title">
                  <SectionTitleLeft
                    desc="Using  to build your site means never worrying about designing another page or cross browser compatibility. Our ever-growing library of components and pre-designed layouts will make your life easier."
