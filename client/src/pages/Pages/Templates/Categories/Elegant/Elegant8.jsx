              ...
              <tbody>
                ...
                <tr>
                  <td style={{ margin: "0.1px", padding: "1px 0px" }}>
                    <span
                      style={{
                        font: "600 1em Verdana, Geneva, sans-serif",
                        color: "rgb(74, 74, 74)",
                      }}
                    >
                      M
          ...
          >
            <tbody>
              <tr style={{ display: "none" }}>
                <td style={{ paddingTop: "15px", margin: "0.1px" }}>
                  <a
                    target="_blank"
                ...
                <td style={{ margin: "0.1px", paddingTop: "15px" }}>
                  ...
                  >
                    <img
                      alt="Meet me on Zoom"
                      maxWidth={182}
                      src="https://img.mysignature.io/a/v1/3/b/e/3be1ed76-e5f2-5c4e-be3f-4e582bedefac.png"
                      style={{ width: "182px" }}
                    />
                  </a>
                </td>
