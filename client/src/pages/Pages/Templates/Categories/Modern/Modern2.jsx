        ...
        <div>
          ...
          <div>
            ...
            >
              <tbody>
                <tr>
                  <td maxWidth={100} className="image1">
                    <img
                      alt="created with MySignature.io"
                      className="cardProfile"
                      maxWidth={100}
                      style={{ width: "100px", maxWidth: "100px" }}
                      src="https://img.mysignature.io/p/c/6/9/c691a29a-a87f-541f-bada-5163ced316c7.png?time=1613559834"
                    />
                  </td>
                </tr>
                <tr>
                      ...
                      <tbody>
                        <tr>
                          <td
                            height={1}
                            style={{
                              borderTop: "2px solid rgb(48, 55, 63)",
                              fontSize: "1px",
                              height: "1px",
                              lineHeight: "1px",
                              width: "30px",
                  ...
                  <table cellSpacing={0} cellPadding={0} border={0}>
                    <tbody>
                      <tr>
                        ...
                        >
                          <i
                            style={{ fontSize: "22px", color: "#30373F" }}
                            className="icon_addon-search-calendar"
                          />
                        </td>
                        <td
