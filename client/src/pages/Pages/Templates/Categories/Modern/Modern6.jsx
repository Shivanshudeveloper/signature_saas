...
const Modern6 = () => {
  ...
  <div id="signature-preview" className="o-signature-preview">
    <div>
          ...
          <tbody><tr>
              ...
              <td valign="middle" style={{margin: '0.1px', fontSize: '1em', verticalAlign: 'middle'}}>
                <table cellSpacing={0} cellPadding={0} border={0} style={{width: '100%', maxWidth: '400px', lineHeight: '1.4', fontFamily: 'Arial, Helvetica, sans-serif', fontSize: '90%', color: 'rgb(0, 0, 1)'}}>
                  <tbody><tr>
                      <td style={{margin: '0.1px', paddingBottom: '1px', font: '600 1.2em Arial, Helvetica, sans-serif', color: 'rgb(53, 54, 61)'}}>
                        Justin Mccullough
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td style={{margin: '0.1px', padding: '1px 0px'}}>
                        <div style={{fontFamily: 'Arial, Helvetica, sans-serif'}}>
                          <a href="tel:+809-890-75" style={{textDecoration: 'none', color: 'rgb(0, 0, 1)'}}>+809-890-75</a> ,  {/**/}
                        </div>
                      </td>
                    </tr>
                    {/**/} 
                    <tr>
                      <td style={{margin: '0.1px', padding: '1px 0px'}}>
                        <div style={{fontFamily: 'Arial, Helvetica, sans-serif'}}><a href="http://www.zenith.com" style={{textDecoration: 'none', color: '#000001'}} target="_blank">www.zenith.com</a></div>
                      </td>
                    </tr>
                    {/**/} 
                    <tr>
      ...
      {/*fragment#d3926f6161#head*/}
      <table cellSpacing={0} cellPadding={0} border={0} fragment="d3926f6161" style={{maxWidth: '500px', color: 'gray', fontFamily: 'Arial', fontSize: '12px'}}>
