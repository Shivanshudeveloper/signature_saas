                ...
                <tr>
                  ...
                  <td
                    ...
                    style={{
                      ...
                      verticalAlign: "top",
                      borderLeft: "1px solid rgb(70, 127, 0)",
                    }}
                  >
                    <table
                      cellSpacing={0}
                        ...
                        <tr>
                          <td style={{ margin: "0.1px" }}>
                            ...
                            >
                              ...
                              <a
                                href="mailto:jacdrakein@gmail.com"
                                target="_blank"
                                style={{
                                  textDecoration: "none",
                                  color: "rgb(0, 0, 1)",
                                  ...
                                  >
                                    ...
                                    >
                                      <i
                                        ...
                                        className="fa fa-tripadvisor icon"
                                      />
                                    </a>
                                  </td>
                                </tr>
                  ...
                  <table cellSpacing={0} cellPadding={0} border={0}>
                    <tbody>
                      <tr>
                        ...
                        >
                          <i
                            style={{ fontSize: "22px", color: "#467F00" }}
                            className="icon_addon-run"
                          />
                        </td>
