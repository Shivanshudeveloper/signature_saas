              ...
              <tbody>
                <tr>
                  ...
                  <td
                    valign="top"
                    style={{
                      borderLeft: "2px solid rgb(223, 16, 87)",
                      margin: "0.1px",
                      verticalAlign: "top",
                      borderTopColor: "rgb(223, 16, 87)",
                      borderRightColor: "rgb(223, 16, 87)",
                      borderBottomColor: "rgb(223, 16, 87)",
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  >
                                    <a
                                      target="_blank"
                                      className="social_link  pinterest"
                                      href="https://mysignature.io/"
                                      style={{
                                        display: "block",
                                        borderRadius: "50%",
              ...
              <tr>
                <td style={{ paddingTop: "14px", margin: "0.1px" }}>
                  ...
                  >
                    <img
                      height={35}
                      src="https://img.mysignature.io/addons/v2/instagram_v1_shape3_b.png?uid=undefined"
                      alt="instagram"
                    />
                  </a>
                  <a
                  ...
                  >
                    <img
                      height={35}
                      src="https://img.mysignature.io/addons/v2/facebook_v1_shape3_b.png?uid=undefined"
                      alt="facebook"
                    />
                  </a>
                  {/**/}
