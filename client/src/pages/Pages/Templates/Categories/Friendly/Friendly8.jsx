                  ...
                  <tr>
                    ...
                    >
                      <img
                        ...
                        src="https://img.mysignature.io/p/5/2/f/52f4288e-4dc8-5102-8765-d5a86e57373e.png?time=1613558929"
                      />
                    </td>
                    <td
                      valign="top"
                      style={{
                        ...
                        verticalAlign: "top",
                        borderLeft: "1px solid rgb(195, 95, 62)",
                      }}
                    >
                      <table
                        cellSpacing={0}
                      ...
                      >
                        <tbody>
                          <tr>
                            <td
                              style={{ margin: "0.1px", paddingBottom: "8px" }}
                            >
                              <span
                                style={{
                          ...
                          <tr>
                            <td style={{ margin: "0.1px" }}>
                              ...
                              >
                                ...
                                <a
                                  href="mailto:kurt.baker@gmail.com"
                                  target="_blank"
                                  style={{
                                    textDecoration: "none",
                                    color: "rgb(0, 0, 1)",
                          ...
                          <tr>
                            <td style={{ margin: "0.1px" }}>
                              ...
                              >
                                ...
                                1107 Pennsylvania St Denver, CO 80203
                              </div>
                            </td>
                          </tr>
                          {/**/}
                    ...
                    <td style={{ margin: "0.1px", paddingTop: "15px" }}>
                      ...
                      >
                        <img
                          alt="created with MySignature.io"
                          maxWidth={446}
                          src="https://img.mysignature.io/b/5/2/f/52f4288e-4dc8-5102-8765-d5a86e57373e.png?time=1613558929"
                        />
                      </a>
                    </td>
                  </tr>
