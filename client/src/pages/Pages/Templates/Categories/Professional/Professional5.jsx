...
const Professional5 = () => {
  return (
    <div>
      1) Professional 5{/* Professional 5 Start */}
                        ...
                        <tr>
                          <td style={{ margin: "0.1px", padding: "1px 0px" }}>
                            ...
                            >
                              ...
                              <a
                                href="https://mysignature.io/redirect/skype:contact_fry?chat"
                                style={{
                                  textDecoration: "none",
                                  color: "rgb(0, 0, 1)",
                                }} className = "name"
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  >
                                    <a
                                      target="_blank"
                                      className="social_link  wordpress"
                                      href="https://mysignature.io/"
                                      style={{
                                        display: "block",
                                        borderRadius: "0%",
                                    ...
                                    >
                                      <i
                                        ...
                                        className="fa fa-wordpress icon"
                                      />
                                    </a>
                                  </td>
                                </tr>
              ...
              <tr>
                <td style={{ paddingTop: "13px", margin: "0.1px" }}>
                  ...
                  >
                    <img
                      height={41}
                      src="https://img.mysignature.io/addons/v2/facebook_v1_shape2_b.png?uid=undefined"
                      alt="facebook"
                    />
                  </a>
                  {/**/}
                  ...
                  >
                    <img
                      height={41}
                      src="https://img.mysignature.io/addons/v2/pinterest_v1_shape2_b.png?uid=undefined"
                      alt="pinterest"
                    />
                  </a>
                  {/**/}
