...
const Professional6 = () => {
  return (
    <div>
      6) Professional 6{/* Professional 6 Start*/}
                        ...
                        <tr>
                          <td style={{ margin: "0.1px", padding: "1px 0px" }}>
                            ...
                            >
                              ...
                              <a
                                href="mailto:arnas@mysticorps.net"
                                target="_blank"
                                style={{
                                  textDecoration: "none",
                                  color: "rgb(0, 0, 1)",
                        ...
                        <tr>
                          <td style={{ margin: "0.1px", padding: "1px 0px" }}>
                            ...
                            >
                              ...
                              <a
                                href="https://mysignature.io/redirect/skype:arnasdeleon?chat"
                                style={{
                                  textDecoration: "none",
                                  color: "rgb(0, 0, 1)",
                                }} className = "name6"
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  >
                                    <a
                                      target="_blank"
                                      className="social_link  skype"
                                      href="https://mysignature.io/redirect/skype:https://mysignature.io/?chat"
                                      style={{
                                        display: "block",
                                        borderRadius: "0%",
                                        width: "22px",
                  ...
                  <table cellSpacing={0} cellPadding={0} border={0}>
                    <tbody>
                      <tr>
                        ...
                        >
                          <i
                            style={{ fontSize: "33px", color: "#9013FE" }}
