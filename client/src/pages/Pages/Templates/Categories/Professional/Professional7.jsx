...
const Professional7 = () => {
  return (
    <div>
      7) Professional 7{/* Professional 7 Start */}
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td style={{ margin: "0.1px", padding: "4px 0 0 0" }}>
                            <a
                              target="_blank"
                              className="social_link  stack-overflow"
                              href="https://mysignature.io/"
                              style={{
                                display: "block",
                                borderRadius: "15%",
                            ...
                            >
                              <i
                                ...
                                className="fa fa-stack-overflow icon"
                              />
                            </a>
                          </td>
                        </tr>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td style={{ margin: "0.1px", padding: "1px 0px" }}>
                            <div style={{ fontFamily: '"Trebuchet MS"' }}>
                              <a
                                href="mailto:brenda@glaciarts.io"
                                target="_blank"
                                style={{
                                  textDecoration: "none",
                                  color: "rgb(0, 0, 1)",
