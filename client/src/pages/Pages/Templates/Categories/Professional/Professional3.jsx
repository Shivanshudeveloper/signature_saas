...
const Professional3 = () => {
  return (
    <div>
      3) Professional 3{/* Professional 3 Start*/}
                        ...
                        <tr>
                          <td style={{ margin: "0.1px", verticalAlign: "top" }} className="image1">
                            <img
                              ...
                              src="https://img.mysignature.io/p/b/7/4/b7447a62-843d-5e10-90ed-cec23a4178b3.png?time=1610636358"
                            />
                          </td>
                                ...
                                <tr>
                                  ...
                                  >
                                    ...
                                    >
                                      skype:
                                      <a
                                        href="https://mysignature.io/redirect/skype:Garry.SE?chat"
                                        style={{
                                          textDecoration: "none",
                                          color: "rgb(0, 0, 0)",
                                        }} className="name6"
                                      ...
                                      | email:
                                      <a
                                        href="mailto:garry@sundray.esate"
                                        target="_blank"
                                        style={{
                                          textDecoration: "none",
                                          color: "rgb(0, 0, 0)",
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          >
                                            <a
                                              target="_blank"
                                              className="social_link  nextdoor"
                                              href="https://mysignature.io/"
                                              style={{
                                                display: "block",
                                                borderRadius: "0%",
              ...
              <tr>
                <td style={{ paddingTop: "5px", margin: "0.1px" }}>
                  ...
                  >
                    <img
                      height={36}
                      src="https://img.mysignature.io/addons/v2/youtube_v3_shape1_i.png?uid=undefined"
                      alt="youtube"
                    />
                  </a>
                  <a
                  ...
                  >
                    <img
                      height={36}
                      src="https://img.mysignature.io/addons/v2/facebook_v2_shape1_i.png?uid=undefined"
                      alt="facebook"
                    />
                  </a>
                  {/**/}
                  ...
                  >
                    <img
                      height={36}
                      src="https://img.mysignature.io/addons/v2/linkedin_v3_shape1_i.png?uid=undefined"
                      alt="linkedin"
                    />
                  </a>
                  {/**/}
