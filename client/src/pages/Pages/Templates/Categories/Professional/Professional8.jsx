...
const Professional8 = () => {
  return (
    <div>
      8) Professional 8{/* Professional 8 Start*/}
        ...
        <div>
          ...
          <div>
            <table
              ...
              border={0}
              className="template6"
              style={{ lineHeight: "1.4", backgroundColor: "rgb(85, 85, 85)" }}
            >
              <tbody>
                <tr>
                                ...
                                <tr>
                                  ...
                                  >
                                    ...
                                    >
                                      {/**/} {/**/} email:
                                      <a
                                        href="mailto:Traynor@mackernstud.org"
                                        target="_blank"
                                        style={{
                                          textDecoration: "none",
                                          color: "rgb(255, 255, 255)",
